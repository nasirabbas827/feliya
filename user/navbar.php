<nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="max-height: 60px;">
    <a class="navbar-brand" href="home.php">
        <img src="../images/Logo.png" alt="Logo" style="max-height: 85px;">
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
            ...
            if (isset($_SESSION["id"]) && !empty($_SESSION["id"])) {
                ...
                echo '<li class="nav-item"><a class="nav-link" href="subscription_status.php">My Subscription</a></li>';
                echo '<li class="nav-item"><a class="nav-link" href="user_widrawl.php">My Widrawl</a></li>';
                echo '<li class="nav-item"><a class="nav-link" href="view_offers.php">Offers</a></li>';
